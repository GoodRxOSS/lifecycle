      ...
      schemas: {
        ...
        CanonicalAgentMessagePart: {
          oneOf: [
            ...
            },
            {
              type: 'object',
              description:
                'Settled tool activity with bounded, secret-scrubbed input/output previews; keeps transcripts and follow-up model input aware of prior tool evidence.',
              properties: {
                type: { type: 'string', enum: ['tool_call'] },
                toolName: { type: 'string', minLength: 1 },
                toolCallId: { type: 'string', minLength: 1 },
                state: { type: 'string', enum: ['completed', 'error', 'denied'] },
        ...
        AgentMessage: {
          ...
          properties: {
            ...
            metadata: {
              oneOf: [
                { $ref: '#/components/schemas/AgentSwitchEventMetadata' },
                { $ref: '#/components/schemas/RuntimeControlsUpdateEventMetadata' },
                { type: 'object' },
              ],
            },
            createdAt: { type: 'string', format: 'date-time', nullable: true },
        ...
        RuntimeControlsUpdateEventMetadata: {
          type: 'object',
          properties: {
            kind: { type: 'string', enum: ['runtime_controls_update'] },
            actor: {
              type: 'object',
              properties: {
                userId: { type: 'string' },
          ...
          required: ['kind', 'actor', 'enabled', 'disabled', 'appliesTo', 'occurredAt'],
          additionalProperties: false,
        },
        ...
        AgentSessionSummary: {
          ...
          properties: {
            session: {
              ...
              properties: {
                id: { type: 'string' },
                status: { type: 'string', enum: ['ready', 'archived', 'error'] },
                userId: { type: 'string' },
                ownerGithubUsername: { type: 'string', nullable: true },
        ...
        AgentPendingAction: {
          ...
          properties: {
            ...
            alwaysAllowEligible: { type: 'boolean' },
          },
          required: [
            'id',
            'kind',
        ...
        AgentSessionControlPlaneConfig: {
          ...
          properties: {
            ...
            maxRunInputTokens: { type: 'integer', minimum: 1 },
        ...
        WorkspaceTemplateBuildState: {
          type: 'object',
          properties: {
            buildId: { type: 'string' },
            backendId: { type: 'string' },
            status: { type: 'string', enum: ['queued', 'running', 'ready', 'error'] },
            stage: { type: 'string', enum: ['queued', 'preparing', 'building', 'configuring', 'ready', 'error'] },
            message: { type: 'string' },
        ...
        WorkspaceTemplateBuildStateResponse: {
          allOf: [
            { $ref: '#/components/schemas/SuccessApiResponse' },
            {
              type: 'object',
              properties: {
                data: { $ref: '#/components/schemas/WorkspaceTemplateBuildState' },
              },
              required: ['data'],
            },
          ],
        ...
        AgentSessionCleanupSettings: {
          ...
          properties: {
            ...
            idleArchiveMs: { type: 'integer', minimum: 1 },
