...
function site(overrides: Partial<SiteResponse> = {}): SiteResponse {
  return {
    ...
    status: 'ready',
    visibility: 'public',
    contentUrl: 'https://docs.example.test',
    openUrl: 'https://ui.example.test/sites/site-1',
    accessRevision: 1,
    contentRevision: 1,
    currentRole: null,
    permissions: { canView: true, canEdit: false, canDelete: false, canChangeVisibility: false },
