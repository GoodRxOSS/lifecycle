...
import {
  ...
  DEFAULT_AGENT_SESSION_IDLE_ARCHIVE_MS,
...
const DEFAULT_CLEANUP = {
  ...
  idleArchiveMs: DEFAULT_AGENT_SESSION_IDLE_ARCHIVE_MS,
...
describe('runtimeConfig', () => {
  ...
  it('falls back to the default control-plane system prompt when unset', () => {
    expect(resolveAgentSessionControlPlaneConfigFromDefaults({})).toEqual({
      ...
      maxRunInputTokens: DEFAULT_AGENT_SESSION_MAX_RUN_INPUT_TOKENS,
