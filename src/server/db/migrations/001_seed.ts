...
export async function up(knex: Knex): Promise<any> {
  ...
  await knex.schema.raw(`
    ...
    INSERT INTO global_config (key, config, "createdAt", "updatedAt", "deletedAt", description) VALUES ('lifecycleDefaults', '{"defaultUUID":"dev-0","defaultPublicUrl":"dev-0.127.0.0.1.nip.io","cfStepType":"helm:1.1.12","ecrDomain":"${
