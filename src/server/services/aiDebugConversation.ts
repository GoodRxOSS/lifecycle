...
import { ConversationState, DebugMessage } from './types/aiDebug';

export default class AIDebugConversationService extends BaseService {
  private readonly CONVERSATION_TTL = 3600;
  private readonly KEY_PREFIX = 'lifecycle:debug:conversation:';
