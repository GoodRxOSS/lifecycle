...
export const AGENT_CAPABILITY_CATALOG: readonly AgentCapabilityCatalogEntry[] = [
  {
    ...
    category: 'read',
    label: 'Read/context',
    description: 'Read session context, workspace state, logs, and non-mutating reference data.',
  ...
  },
  {
    ...
    toolKeys: ['workspace.write_file', 'workspace.edit_file'],
  ...
  },
  {
    ...
    description: 'Stage, commit, and manage repository branches in a workspace.',
    defaultAvailability: 'all_users',
    defaultApprovalMode: 'require_approval',
    runtimeCapabilityKey: 'git_write',
    toolKeys: ['git.add', 'git.commit', 'git.branch'],
    resourceGrants: ['git_write'],
    sourceKinds: ['workspace_session'],
    userSelectable: true,
  },
  {
    ...
    description: 'Use tools that can reach external network resources.',
    defaultAvailability: 'all_users',
    defaultApprovalMode: 'require_approval',
  ...
  },
  {
    ...
    description: 'Publish or expose workspace preview services.',
    defaultAvailability: 'all_users',
    defaultApprovalMode: 'require_approval',
    runtimeCapabilityKey: 'deploy_k8s_mutation',
    toolKeys: ['publish_http'],
