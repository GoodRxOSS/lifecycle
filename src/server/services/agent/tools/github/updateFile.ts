...
function isLifecycleConfigPath(filePath: string): boolean {
        ...
        if (!validation.valid) {
          return {
            ...this.createErrorResult(
              `The proposed ${filePath} is not a valid Lifecycle config and was NOT committed. Fix the content and resubmit. Validation error:\n${validation.error}`,
