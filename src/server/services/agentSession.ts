...
export default class AgentSessionService {
  ...
  static async releaseWorkspace(sessionId: string): Promise<void> {
    return this.teardownWorkspaceRuntime(sessionId, { archive: false });
  }
  ...
  private static async teardownWorkspaceRuntime(sessionId: string, opts: { archive: boolean }): Promise<void> {
